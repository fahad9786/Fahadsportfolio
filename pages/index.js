      ...
      <main className="bg-white px-10 md:px-20 lg:px-40 dark:bg-gray-900" >
        <section className="min-h-screen">
          <nav className="py-10 mb-12 flex justify-between">
            ...
            <ul className="flex items-center">
              <li>
                <BsFillMoonStarsFill onClick={() => setDarkMode(!darkMode)}className="cursor-pointe text-2xl dark:text-white"> </BsFillMoonStarsFill>
              </li>
        ...
        <section>
          <div>
            ...
            <p className="text-md py-2 leading-8 text-gray-800 dark:text-white" >Currently I am pursing an education in the 
            <span className="text-teal-500"> User Experience</span> and <span className="text-teal-500">Software Development fields</span>
            </p> 
            <p className="text-md py-2 leading-8 text-gray-800 dark:text-white">  I'm currently in search of co-op opportunities for the upcoming summer while actively working on several side projects. As a Computer Science student with a focus on UX Design, I'm excited to apply my skills and contribute to innovative teams.</p> 
          </div>
        ...
        <section>
          ...
          <p className="text-md py-2 leading-8 text-gray-800 dark:text-white" >Currently I am pursing an education in the 
            <span className="text-teal-500 dark:text-teal-200"> User Experience</span> and <span className="text-teal-500">Software Development fields</span>
            </p> 
            <p className="text-md py-2 leading-8 text-gray-800 dark:text-white">  I'm currently in search of co-op opportunities for the upcoming summer while actively working on several side projects. As a UX and CS student with a focus on UX Design, I'm excited to apply my skills and contribute to innovative teams.</p> 
          </div>
